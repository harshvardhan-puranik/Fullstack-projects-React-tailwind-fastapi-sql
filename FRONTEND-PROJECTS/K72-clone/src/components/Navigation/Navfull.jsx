...
const Navfull = () => {
    ...
    tl.from(fullLinksNavRef.current,{
        opacity:0
    })
    tl.from('.link',{
        opacity:0,
    ...
    return (
        ...
        <div className='w-full h-screen bg-black text-white font-[font2]'>
         ...
         <div ref={fullLinksNavRef} className='relative h-full w-full'>
               <div className='h-2/10 border-b border-gray-400 flex w-full items-start p-5 justify-between'>
                ...
                <div className='parent  h-28 w-28 relative cursor-pointer'>
